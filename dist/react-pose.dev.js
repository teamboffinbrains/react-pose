    ...
    ***************************************************************************** */
    ...
    var makeUIEventApplicator = function (_a) {
        ...
        return function (element, activeActions, poser, config) {
            var startPoseName = config.posePrefix ? config.posePrefix + startPose : startPose;
    ...
    var createPoseConfig = function (element, _a) {
        var onDragStart = _a.onDragStart,
            ...
            posePrefix = _a.posePrefix,
            config = __rest$2(_a, ["onDragStart", "onDragEnd", "onPressStart", "onPressEnd", "draggable", "hoverable", "focusable", "pressable", "dragBounds", "posePrefix"]);
